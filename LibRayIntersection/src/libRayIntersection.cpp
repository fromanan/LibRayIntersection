// libRayIntersection.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include "libRayIntersection.h"
...
ClibRayIntersectionApp::ClibRayIntersectionApp()
{
...
BOOL ClibRayIntersectionApp::InitInstance()
{
